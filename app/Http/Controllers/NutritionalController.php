...
class NutritionalController extends Controller
{
    public function index(){
        ...
        $freshCategory = Category::where('parent_id', 3)->first();
        ...
        $categories1 = Category::where('parent_id', '!=', -1)->get();
                ...
                return view('pages.Nutritional', ['categories'=>$categories,'categories1'=>$categories1, 'latestProducts'=>$latestProducts, 'freshProducts'=>$freshProducts,'topSellingProducts'=>$topSellingProducts]);
